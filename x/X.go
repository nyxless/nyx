...
var (
	...
	Conf_auth_api_check_enabled bool
	...
	ConfAuthApiCheckMethod map[string]struct{}
	ConfAuthApiCheckExcept map[string]struct{}
	ConfAuthRpcCheckMethod map[string]struct{}
	ConfAuthRpcCheckExcept map[string]struct{}
